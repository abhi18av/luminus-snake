...
if((i < len)){
var k = (ks[i]);
var G__36868 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__36869 = (i + (1));
m = G__36868;
i = G__36869;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__36870 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__36870);
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__36872 = c;
var G__36872__$1 = (((G__36872 == null))?null:G__36872.prototype);
if((G__36872__$1 == null)){
return null;
} else {
return (G__36872__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__36874 = c;
var G__36874__$1 = (((G__36874 == null))?null:G__36874.prototype);
if((G__36874__$1 == null)){
return null;
} else {
return (G__36874__$1["render"]);
}
})() == null))));
});
...
return (function() { 
var G__36878__delegate = function (args){
var G__36876 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__36876) : reagent.impl.component.as_element.call(null,G__36876));
};
...
while (G__36879__i < G__36879__a.length) {G__36879__a[G__36879__i] = arguments[G__36879__i + 0]; ++G__36879__i;}
  args = new cljs.core.IndexedSeq(G__36879__a,0,null);
} 
return G__36878__delegate.call(this,args);};
G__36878.cljs$lang$maxFixedArity = 0;
G__36878.cljs$lang$applyTo = (function (arglist__36880){
var args = cljs.core.seq(arglist__36880);
return G__36878__delegate(args);
});
...
var _STAR_current_component_STAR_36882 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_36882;
}});
...
var G__36883 = key;
var G__36883__$1 = (((G__36883 instanceof cljs.core.Keyword))?G__36883.fqn:null);
switch (G__36883__$1) {
...
return ((function (G__36883,G__36883__$1){
...
var c = this;
var G__36884_36886 = (c["cljsRatom"]);
if((G__36884_36886 == null)){
} else {
reagent.ratom.dispose_BANG_(G__36884_36886);
}
...
var renders_36888 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_36889 = cljs.core.first(cljs.core.vals(renders_36888));
if((cljs.core.count(renders_36888) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36888))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36889)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36889], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__36887 = name;
switch (G__36887) {
case "":
...
var G__36892 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__36892);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__36893 = fiber;
var G__36893__$1 = (((G__36893 == null))?null:(G__36893["type"]));
if((G__36893__$1 == null)){
return null;
} else {
return (G__36893__$1["displayName"]);
}
})();
var parent = (function (){var G__36894 = fiber;
if((G__36894 == null)){
return null;
} else {
return (G__36894["return"]);
}
})();
var path = (function (){var G__36895 = parent;
var G__36895__$1 = (((G__36895 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__36895) : reagent.impl.component.fiber_component_path.call(null,G__36895)));
if((G__36895__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36895__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3922__auto__ = (function (){var G__36897 = c;
if((G__36897 == null)){
return null;
} else {
return (G__36897["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__36898._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3922__auto__ = (function (){var G__36900 = c;
if((G__36900 == null)){
return null;
} else {
return (G__36900["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var or__3922__auto____$1 = (function (){var G__36902 = c;
if((G__36902 == null)){
return null;
} else {
return G__36902._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3922__auto__ = (function (){var G__36904 = instance;
if((G__36904 == null)){
return null;
} else {
return (G__36904["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var G__36905 = instance;
if((G__36905 == null)){
return null;
} else {
return G__36905._currentElement;
}
}
})();
var name = (function (){var G__36906 = elem;
var G__36906__$1 = (((G__36906 == null))?null:(G__36906["type"]));
if((G__36906__$1 == null)){
return null;
} else {
return (G__36906__$1["displayName"]);
}
})();
var owner = (function (){var or__3922__auto__ = (function (){var G__36908 = elem;
if((G__36908 == null)){
return null;
} else {
return (G__36908["_owner"]);
}
})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
return G__36909._owner;
}
}
})();
var path = (function (){var G__36910 = owner;
var G__36910__$1 = (((G__36910 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__36910) : reagent.impl.component.component_path.call(null,G__36910)));
if((G__36910__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36910__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__36911 = c;
var G__36911__$1 = (((G__36911 == null))?null:G__36911.constructor);
if((G__36911__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__36911__$1);
}
}
})();
