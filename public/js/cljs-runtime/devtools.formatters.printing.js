...
var G__29404 = (i__4500__auto___29402 + (1));
i__4500__auto___29402 = G__29404;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29395){
var G__29396 = cljs.core.first(seq29395);
var seq29395__$1 = cljs.core.next(seq29395);
var G__29397 = cljs.core.first(seq29395__$1);
var seq29395__$2 = cljs.core.next(seq29395__$1);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29396,G__29397,seq29395__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29411_SHARP_){
return !((cljs.core.meta(p1__29411_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29412__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e29417){var _e__27696__auto__ = e29417;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e29419){var _e__27696__auto__ = e29419;
return false;
}}
})())){
...
var _STAR_current_state_STAR_29422 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state();

try{var map__29423 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29423__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_29422;
}});
...
;
var temp__5455__auto___29435 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5455__auto___29435)){
var managed_print_level_29436 = temp__5455__auto___29435;
var _STAR_print_level_STAR_29434_29437 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_29436;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR_29434_29437,managed_print_level_29436,temp__5455__auto___29435,writer,opts,job_fn){
return (function (p1__29433_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__29433_SHARP_,null);
});})(_STAR_print_level_STAR_29434_29437,managed_print_level_29436,temp__5455__auto___29435,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_29434_29437;
}} else {
job_fn();
}
