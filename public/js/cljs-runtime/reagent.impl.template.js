...
var G__36912 = o;
(G__36912[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__36913__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__36913 = function (var_args){
var args = null;
...
return G__36913__delegate.call(this,args);};
G__36913.cljs$lang$maxFixedArity = 0;
G__36913.cljs$lang$applyTo = (function (arglist__36915){
var args = cljs.core.seq(arglist__36915);
return G__36913__delegate(args);
});
G__36913.cljs$core$IFn$_invoke$arity$variadic = G__36913__delegate;
return G__36913;
})()
;
} else {
...
var G__36916 = o;
(G__36916[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__36921 = props;
var G__36921__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36921,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36921);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36921__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__36922){
...
var props = map__36923__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36923__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__36925){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36926__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__36926,map__36926__$1,on_write){
return (function (){
...
});})(node_value,map__36926,map__36926__$1,on_write))
);
} else {
...
var G__36929 = jsprops;
(G__36929["defaultValue"] = value);

(G__36929["onChange"] = ((function (G__36929,v,value,on_change){
return (function (p1__36928_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__36928_SHARP_);
});})(G__36929,v,value,on_change))
);
...
var vec__36932 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36932,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36932,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36932,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___36936 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___36936 == null)){
} else {
var key_36937 = temp__5461__auto___36936;
(jsprops["key"] = key_36937);
}
...
var temp__5461__auto___36938 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___36938 == null)){
} else {
var key_36939 = temp__5461__auto___36938;
reagent.impl.template.oset(jsprops,"key",key_36939);
}
...
var G__36940 = reagent.impl.template.__GT_NativeWrapper();
(G__36940["name"] = c);
...
var G__36941 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__36941) : reagent.impl.template.as_element.call(null,G__36941));
} else {
...
var len__4499__auto___36946 = arguments.length;
var i__4500__auto___36947 = (0);
while(true){
if((i__4500__auto___36947 < len__4499__auto___36946)){
args__4502__auto__.push((arguments[i__4500__auto___36947]));

var G__36948 = (i__4500__auto___36947 + (1));
i__4500__auto___36947 = G__36948;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq36944){
var G__36945 = cljs.core.first(seq36944);
var seq36944__$1 = cljs.core.next(seq36944);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36945,seq36944__$1);
});
...
break;
default:
var G__36951 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__36951;
continue;
...
var n__4376__auto___36953 = a.length;
var i_36954 = (0);
while(true){
if((i_36954 < n__4376__auto___36953)){
(a[i_36954] = reagent.impl.template.as_element((a[i_36954])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4376__auto___36956 = a.length;
var i_36957 = (0);
while(true){
if((i_36957 < n__4376__auto___36956)){
var val_36958 = (a[i_36957]);
if(((cljs.core.vector_QMARK_(val_36958)) && ((reagent.impl.template.key_from_vec(val_36958) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_36957] = reagent.impl.template.as_element(val_36958));

var G__36959 = (i_36957 + (1));
i_36957 = G__36959;
continue;
} else {
}
...
var ctx = ({});
var vec__36960 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36960,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36960,(1),null);
...
var G__36963 = (cljs.core.count(argv) - first_child);
switch (G__36963) {
case (0):
...
case (1):
var G__36964 = comp;
var G__36965 = jsprops;
var G__36966 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__36964,G__36965,G__36966);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__36963){
